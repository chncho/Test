...
public class AntZip {
	...
	private final static String ZIP_ENCODE = "GB18030";
	...
	public void doZip(String zipDirectory, String zipFileName){
		File zipDir = new File(zipDirectory);
		doZip(new File[] { zipDir }, zipFileName);
	}
	...
	public void unZip(String unZipFileName, String outputPath) {
		...
		try {
			this.zipFile = new ZipFile(unZipFileName, ZIP_ENCODE);
	...
	public static void main(String[] args) throws Exception {
		...
		// 将第一个文件名作为zip文件名
//		zip.doZip("C:/tmp/testZip" , "C:/tmp/testZipF/testZip10.zip");
//		zip.unZip("C:/tmp/testZipF/testZip10.zip", "C:/tmp/testZipF/testZip10");

//		zip.doZip(new File[]{
//				new File("C:/tmp/testZipF/testZip/aaa_111.txt"),
//				new File("C:/tmp/testZipF/testZip/aaa_111_1.txt"),
//				new File("C:/tmp/testZipF/testZip/aaa_111_2.txt"),
//				new File("C:/tmp/testZipF/testZip/aaa_111_3.txt")
//		}, "C:/tmp/testZipF/ttt");
		...
		// AntZip zip = new AntZip();
		//
		// if (args[0].equals("-zip")) { // 将后续参数全部转化为File对象
		// File[] files = new File[args.length - 1];
		// for (int i = 0; i < args.length - 1; i++) {
		// files = new File(args[i + 1]);
		// }
		//
		...
		// System.out
		// .println("压缩:java AntZip -zip [directoryName | fileName]... ");
