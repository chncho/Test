package math.caculate.expression;
...
//		ReflectionUtils.getMethod(target.getClass(), methodName, argClasses);
		Method m = ReflectionUtils.getMethod(Ok.class, "haha", new Class[]{String.class});
	...
	public static void expTest(){
		...
		int a=1;
		int b=2;
		Object returnVal = new String() ;
		Expression exp = new Expression(int.class,o,"ook",new Object[]{1,2});
		try {
			exp.execute();
		} catch (Exception e) {
			e.printStackTrace();
